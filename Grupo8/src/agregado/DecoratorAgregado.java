...
/**
 * @author Taller1 <br>
 *         Clase para aniadir nuevos agregados al Servicio, utilizando el patron
 *         Decorator
 */
public abstract class DecoratorAgregado implements I_Contratable {
	 ...
	 * 
	 * @param cantLineas:  parametro de tipo int que representa la cantidad de
	 *                     lineas del nuevo agregado
	 * @param contratable: parametro de tipo I_Contratable que representa el
	 *                     servicio al que se le aniade el Agregado
	 */
	 ...
	 * 
	 * @param cantLineas: Nuevo numero de lineas de este agregado, tiene que ser un
	 *                    numero positivo
	 */
	...
	/**
	 * @return Devuelve el Servicio de Internet, o en caso de haber mas de un
	 *         agregado devuelve el siguiente Agregado
	 */
